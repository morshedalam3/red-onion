            ...
            <div className="container">
                ...
                <ul className="navbar-nav align-items-center">
                    <li className="nav-item active">
                        <Link to="/checkout" className="nav-link"><FontAwesomeIcon className="cart-icon" icon={faCartArrowDown} /><span className="badge text-dark">{props.cart.length}</span></Link>
                    </li>
